...
SECRET_KEY = 'django-insecure-(0ppbo=%@2l-tw495v&-gj+00s01(*7ax=@y61j2r6v&&22w7*'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("redis", 6379)],  # match your docker-compose redis service
        },
    },
}

# Configure Email Settings in settings.py
# Use environment variables or django-environ to avoid hardcoding secrets.
...
DEFAULT_FROM_EMAIL = 'Your Project Name <your_email@example.com>'
